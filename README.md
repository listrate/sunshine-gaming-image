...
adds the X11 and Intel VA-API runtime libraries needed for hardware capture and
encoding. It does not contain games, ROMs, BIOS files, credentials, or cluster
configuration.
